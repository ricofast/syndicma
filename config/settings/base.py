"""
Django settings for syndicma project.
...
SHARED_APPS = (
    ...
    "django_comments_xtd",
    "django_comments",
    "syndicma.profiles.apps.ProfilesConfig",

    "syndicma.syndic.apps.SyndicConfig",
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "syndicma/templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "syndicma.syndic.context_processors.academicyearname",
                "syndicma.syndic.context_processors.academicyearnames",
                "syndicma.syndic.context_processors.centername",
                "syndicma.syndic.context_processors.cityname",
                "syndicma.syndic.context_processors.notificates",
                "syndicma.syndic.context_processors.schoolgroupname",
                "syndicma.syndic.context_processors.loggedins",
                "syndicma.syndic.context_processors.notifyStudent",
                "syndicma.syndic.context_processors.activestudent",
            ],
        },
    },
]
...
STATIC_URL = "/static/"
STATICFILES_DIRS = [str(BASE_DIR("syndicma/static"))]
...
admins_data = env.tuple(
    "DJANGO_ADMINS", default="Open Course <syndicma2020@mail.com>"
)
...
ACCOUNT_FORMS = {"signup": "syndicma.profiles.forms.ProfileCreateForm"}
...
CRONJOBS = [
    ('*/1 * * * *', 'syndicma.syndic.cron.scheduled_job')
]
