    ...
    def save(self, request):
        with transaction.atomic():
            ...
            if user_type == "superadmin":
                ...
                perm = get_object_or_404(Permission, codename="add_grade")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="delete_grade")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="add_center")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="add_centerlevel")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="delete_center")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="delete_centerlevel")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="change_coursetime")
                user.user_permissions.add(perm)

            elif user_type == "regadmin":
                perm = get_object_or_404(Permission, codename="manage_classe")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_course")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_courseoutline")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_coursetime")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="change_coursetime")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_attendance")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_coursework")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_holidays")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_center")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_centerlevel")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_coursegrades")
                user.user_permissions.add(perm)
                perm = get_object_or_404(Permission, codename="manage_grade")
                user.user_permissions.add(perm)
